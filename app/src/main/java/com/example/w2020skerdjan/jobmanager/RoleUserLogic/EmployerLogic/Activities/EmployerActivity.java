...
import com.example.w2020skerdjan.jobmanager.RoleUserLogic.EmployerLogic.Fragments.EmployerProfileFragment;
import com.example.w2020skerdjan.jobmanager.RoleUserLogic.EmployerLogic.Fragments.EmployerSearchCompaniesFragment;
...
//create the drawer and remember the `Drawer` result object
    ...
    public void initEmployerProfile(){
        ...
        intent.putExtra(EmployerProfile.EMAIL_ARG, memberEmail);
        startActivity(intent);
    }

    public void initEmployerProfileFragment(){
        EmployerProfileFragment employerProfile = EmployerProfileFragment.newInstance(memberEmail);
        fragmentTransaction = getSupportFragmentManager().beginTransaction();
        fragmentTransaction.addToBackStack("employerProfileFragment");
        fragmentTransaction.replace(R.id.fragmentLogin, employerProfile, "employerProfileFragment");
        fragmentTransaction.commitAllowingStateLoss();
    }
    ...
    public void initSearchCompaniesFragment() {
        fragmentTransaction=getSupportFragmentManager().beginTransaction();
        EmployerSearchCompaniesFragment employerSearchCompaniesFragment = new EmployerSearchCompaniesFragment();
        fragmentTransaction.addToBackStack("employerSearchCompaniesFragment");
        fragmentTransaction.replace(R.id.fragmentLogin, employerSearchCompaniesFragment, "employerSearchCompaniesFragment");
        fragmentTransaction.commitAllowingStateLoss();
    }
}
