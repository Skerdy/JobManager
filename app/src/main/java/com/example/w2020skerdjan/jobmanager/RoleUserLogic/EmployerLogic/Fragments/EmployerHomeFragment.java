...
public class EmployerHomeFragment extends Fragment {
    ...
    private CardView searchJobs, myJobs, findInMap, findCompanies;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        findCompanies.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((EmployerActivity)getActivity()).initSearchCompaniesFragment();
            }
        });
    }
    ...
    private void initViews(View view){
        ...
        findCompanies = view.findViewById(R.id.findCompanies);
    }
}
